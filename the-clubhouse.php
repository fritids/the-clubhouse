...
/**
 * TODO:
 * - make error codes unique, and require
 * - update/insert "intelligence" (don't run queries if data doesn't change)
 * - data export tools
 * - uninstall cleanup and data export check
 * - localization
 * - sortable, ensure works for touch devices, and consider issue of trackpad accidental select and move
 *
 * - Divisions
 *   - increase efficiency of ordering feature
 *
 * - Players
 *   - club association (local, other)
 *
 * - Events
 *   - front-end output
 *   - sponsor manager
 *   - Tie into Scoring System
